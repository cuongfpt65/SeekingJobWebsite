...
<header class="navbar1">
    <div class="container1">
       ...
       <nav class="columnh">
            ...
            <a href="AboutUsEmployee.jsp" class="nav-link ">About</a>
            <a href="ApplyController?action=ApplyHistory" class="nav-link ">List CV Applied</a>
            <a href="ContactEmployee.jsp" class="nav-link ">Contact</a>
        </nav>
        <div class="column1h">
            <div class="account-dropdown">
                <a href="#" class="buttonh">
                    <span class="account-text" style=" margin-right: 10px;">${nameEmployee.lastName}${nameEmployee  .firstName}</span>
                    <i class="fas fa-user-circle"></i>
                </a>
                <div class="dropdown-content">
                    <a href="employeeProfile?action=employeeProfile">Profile</a>
