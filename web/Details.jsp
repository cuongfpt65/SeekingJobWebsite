                ...
                <div class="col-sm-8">
                    ...
                    <div class="post-item">
                        <div class="post-image col-sm-5">
                            <img src="${postD.image}" alt="${postD.title}">
                        </div>
                        ...
                        <div class="post-conten col-sm-3">
                            ...
                            <p><a <link rel="stylesheet" href="url">  ${postD.idCompany} </a></p> 
                            ...
                            <div>
                                <p class="icon-container">
                                    ...
                                    <span class="salary-text">${postD.salary}/Month</span>
                                </p>
                            ...
                            `
                            <div class="button-ud">
                                <button><a href="/postController?action=loadupdate&postId=${postD.id}" class="btn btn-info">Update</a></button>
                                   
                                <button><a href="/postController?action=deletePost&postId=${postD.id}" class="btn btn-info">Delete</a></button>
                            </div>
