...
<html>
    ...
    <body>
        ...
        <title>Post Details Company</title>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="post-item">
                        ...
                        <div class="post-conten col-sm-3">
                            ...
                            `
                            <div class="button-ud">
                                <button class="btn btn-info"><a href="/postController?action=loadupdate&postId=${postD.id}" >Updata</a></button>
                                <div class="options btn btn-info">
                                    <button  onclick="deletePost('${postD.id}')" class="btn btn-info">Delete</button>
                                </div>
                            </div>
